      ...
      <div className="card card-hover" style={{ overflow: 'hidden', cursor: 'pointer' }}>
        <div style={{ position: 'relative', height: 190, overflow: 'hidden', background: 'var(--cream-dark)' }}>
          ...
          <div style={{ position: 'absolute', top: 10, left: 10, display: 'flex', gap: 5 }}>
            ...
            <span style={{ background: status.bg, color: status.color, fontSize: 10, fontWeight: 700, padding: '3px 8px', borderRadius: 20 }}>
              {status.label}
            </span>
          </div>
          <div style={{ position: 'absolute', top: 10, right: 10, background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(4px)', borderRadius: 8, padding: '3px 8px', fontSize: 11, color: 'var(--charcoal-mid)', fontWeight: 500 }}>
            {propType?.label}
          </div>
